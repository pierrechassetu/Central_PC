...
class Task_Response(metaclass=Metaclass_Task_Response):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            ...
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        from geometry_msgs.msg import Point
        self.task = kwargs.get('task', Point())
    ...
    def task(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'task' field must be a sub message of type 'Point'"
        self._task = value
...
class Metaclass_Task(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _task
...
class Task(metaclass=Metaclass_Task):
    from interfaces.srv._task import Task_Request as Request
    from interfaces.srv._task import Task_Response as Response
