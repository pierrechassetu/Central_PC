...
#ifndef JETBOT_ACTIONS__ACTION__DETAIL__BASIC_CONTROL__FUNCTIONS_H_
#define JETBOT_ACTIONS__ACTION__DETAIL__BASIC_CONTROL__FUNCTIONS_H_
...
#include "jetbot_actions/msg/rosidl_generator_c__visibility_control.h"

#include "jetbot_actions/action/detail/basic_control__struct.h"

/// Initialize action/BasicControl message.
/**
...
/// Create action/BasicControl message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetbot_actions__action__BasicControl_Goal__init().
...
/// Destroy action/BasicControl message.
/**
 * It calls
 * jetbot_actions__action__BasicControl_Goal__fini()
...
/// Initialize array of action/BasicControl messages.
/**
...
/// Finalize array of action/BasicControl messages.
/**
 * It calls
 * jetbot_actions__action__BasicControl_Goal__fini()
...
/// Create array of action/BasicControl messages.
/**
 * It allocates the memory for the array and calls
 * jetbot_actions__action__BasicControl_Goal__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of action/BasicControl messages.
/**
 * It calls
 * jetbot_actions__action__BasicControl_Goal__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetbot_actions__action__BasicControl_Result__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_Result__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It allocates the memory for the array and calls
 * jetbot_actions__action__BasicControl_Result__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_Result__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetbot_actions__action__BasicControl_Feedback__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_Feedback__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It allocates the memory for the array and calls
 * jetbot_actions__action__BasicControl_Feedback__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_Feedback__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetbot_actions__action__BasicControl_SendGoal_Request__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_SendGoal_Request__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It allocates the memory for the array and calls
 * jetbot_actions__action__BasicControl_SendGoal_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_SendGoal_Request__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetbot_actions__action__BasicControl_SendGoal_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_SendGoal_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It allocates the memory for the array and calls
 * jetbot_actions__action__BasicControl_SendGoal_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_SendGoal_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetbot_actions__action__BasicControl_GetResult_Request__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_GetResult_Request__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It allocates the memory for the array and calls
 * jetbot_actions__action__BasicControl_GetResult_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_GetResult_Request__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetbot_actions__action__BasicControl_GetResult_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_GetResult_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It allocates the memory for the array and calls
 * jetbot_actions__action__BasicControl_GetResult_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_GetResult_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jetbot_actions__action__BasicControl_FeedbackMessage__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_FeedbackMessage__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It allocates the memory for the array and calls
 * jetbot_actions__action__BasicControl_FeedbackMessage__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jetbot_actions
...
/**
 * It calls
 * jetbot_actions__action__BasicControl_FeedbackMessage__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // JETBOT_ACTIONS__ACTION__DETAIL__BASIC_CONTROL__FUNCTIONS_H_
